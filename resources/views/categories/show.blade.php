            ...
            <div class="card invoice">
                <div class="card-body p-4 p-md-5">
                    <div class="col-12 col-lg-auto mb-5 mb-lg-0 text-center text-lg-start">
                        <img style=" width: 30%; object-fit: cover;	" class=" rounded-circle" src="{{Storage::url($category->image)}}" alt="">
                    </div>
                    <div class="table-responsive">
                        <table class="table table-borderless mb-5">
                            ...
                            <tr class="border-bottom">
                                <td>
                                    <div class="small text-muted d-none d-md-block">{{$category->name}}</div>
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <td>
                                    <div class="fw-bold">Описание категории:</div>
                                    <div class="small text-muted d-none d-md-block">{{$category->description}}</div>
                                </td>
                            </tr>
                            <tr class="border-bottom">
                                <td>
                                    <div class="fw-bold">Код категории:</div>
                                    <div class="small text-muted d-none d-md-block">{{$category->code}}</div>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-end pb-0" colspan="3">
                                    <div class="text-uppercase small fw-700 text-muted">Всего товаров в данной
                                        категории:
                                    </div>
                                </td>
                                <td class="text-end pb-0">
                                    <div class="h5 mb-0 fw-700">{{$category->products->count()}}</div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
