                                ...
                                <div class="widget-color-list widget-color-box scroll-box-default">
                                    <form action="#">
                                        ...
                                        <div class="single-widget-category">
                                            ...
                                            <label for="color-item-2" class="color-green-bg">Green
                                                <span>(02)</span></label>
                                        </div>
                                        <div class="single-widget-category">
                                            <input type="checkbox" id="color-item-3" name="cat-item">
                                            <label for="color-item-3" class="color-blue-bg">Blue
                                                <span>(06)</span></label>
                                        </div>
                                        <div class="single-widget-category">
                                        ...
                                        <div class="single-widget-category">
                                            ...
                                            <label for="color-item-5" class="color-gray-bg">Gray
                                                <span>(09)</span></label>
                                        </div>
                                        <div class="single-widget-category">
                                            <input type="checkbox" id="color-item-7" class="white-input"
                                                   name="cat-item">
                                            <label for="color-item-7" class="color-white-bg">White
                                                <span>(04)</span></label>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="tab-pane fade active show" id="tab1">
                                <div class="row">
                                    ...
                                    @foreach($product as $prod_det)
                                        <form action="{{route('cart-add', $prod_det)}}" method="POST" class="col-xxl-3 col-xl-4 col-lg-4 col-md-6">
                                                <div class="product__item mb-20">
                                                    ...
                                                    <div class="product__content">
                                                        ...
                                                        <div class="product__select-button">
                                                            <button type="submit" class="select-btn w-100">В корзину</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            @csrf
                                            ...
                                            <div class="row align-items-xl-center">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="wood-product-content wood-product-list-content">
                                                        ...
                                                        <p>Claritas est etiam processus A Capitalize on low hanging
                                                            fruit to identify a ballpark value added activity to
                                                            beta test. Override the digital divide with additional
                                                            clickthroughs from DevOps. Typi non habent claritatem
                                        ...
                                        <div class="single-product mb-30 wood-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="wood-product-content wood-product-list-content">
                                                        <h4 class="pro-title pro-title-1"><a
                                                                href="product-details.html">Wooden Single Drawer</a>
                                                        </h4>
                                                        <div class="pro-price">
                                                            <span>$120.00</span>
                                                            <del>$150.00</del>
                                        ...
                                        <div class="single-product mb-30 wood-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="wood-product-content wood-product-list-content">
                                                        <h4 class="pro-title pro-title-1"><a
                                                                href="product-details.html">Smart Watches Wood</a></h4>
                                                        <div class="pro-price">
                                                            <span>$120.00</span>
                                                            <del>$150.00</del>
                                                        </div>
                                        ...
                                        <div class="single-product mb-30 wood-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="wood-product-content wood-product-list-content">
                                                        <h4 class="pro-title pro-title-1"><a
                                                                href="product-details.html">Panton Tunior Chair</a></h4>
                                                        <div class="pro-price">
                                                            <span>$200.00</span>
                                                            <del>$400.00</del>
                                                        </div>
                                        ...
                                        <div class="single-product mb-30 wood-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="wood-product-content wood-product-list-content">
                                                        <h4 class="pro-title pro-title-1"><a
                                                                href="product-details.html">Eames Lounge Chair</a></h4>
                                                        <div class="pro-price">
                                                            <span>$150.00</span>
                                                            <del>$200.00</del>
                                                        </div>
                                        ...
                                        <div class="single-product mb-30 wood-list-product-wrap">
                                            <div class="row align-items-xl-center">
                                                ...
                                                <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
                                                    <div class="wood-product-content wood-product-list-content">
                                                        <h4 class="pro-title pro-title-1"><a
                                                                href="product-details.html">Nerd Wooden Chair</a></h4>
                                                        <div class="pro-price">
                                                            <span>$110.00</span>
                                                            <del>$180.00</del>
                                                        </div>
