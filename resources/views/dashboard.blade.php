...
@section('title' , 'Элина мебель || Панель администратора')
@section('content')
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <form action="{{route('search')}}" method="POST"
                ...
                <div class="input-group">
                    <input name="name" id="search_product" type="text" class="form-control bg-light border-0 small" placeholder="Поиск..."
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="card shadow mb-4">
                        <div
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Статистика посещаемости сайта:</h6>
